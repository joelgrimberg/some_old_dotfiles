#!/usr/bin/env bash
# Taken from https://mths.be/osx / adjusted to personal settings for osx
...
# Energy settings when mounted to power circuit
sudo pmset -c displaysleep 0
sudo pmset -c sleep 0

# Energy settings with battery only
...
# Set sidebar icon size to medium -- (this is Apples default behavior)
defaults write NSGlobalDomain NSTableViewDefaultSizeMode -int 2

# Always show scrollbars (this is Apples default behavior)
...
# Set Help Viewer windows to non-floating mode, meaning it will show up in the dock when open.
...
# Enable hibernation mode 3, which copies RAM -> HD each sleep mode
# if this is killingly slowing things up, put to 0, but rather not,
# as any work done when entering sleep mode gets lost when battery runs out of
# power, which happens A LOT and OFTEN on my older MacBook.
sudo pmset -a hibernatemode 3

# The below section should ONLY be enabled on hibernation mode 0 set above...
...
###############################################################################
# My Trackpad settings, which are the ones I love and use                     #
###############################################################################
echo "Trackpad"
...
defaults write com.apple.driver.AppleBluetoothMultitouch.trackpad "TrackpadScroll" '2'
...
defaults write com.apple.driver.AppleBluetoothMultitouch.trackpad "TrackpadThreeFingerVertSwipeGesture" '1'
...
# Disable press-and-hold for keys (this is iOS keyboard-like behavior) in favor of key repeat
...
# Disable auto-correct --> VERY important
...
# don't know why this should be currentHost material, but hey...
...
# Enable anti-aliasing for lcd displays
...
# Set my home folder as the default location for new Finder windows
...
# Finder: hide status bar (bar at the bottom of the screen telling useless info)
...
# Enable spring loading for directories - spring loading is moving files through directories
# while holding the file above the directory
defaults write NSGlobalDomain com.apple.springing.enabled -bool true
# Remove the spring loading delay for directories - default is 0.5
...
###############################################################################
echo "Dock / Dashboard / Hotttt corners"
...
# Always animate opening applications from the Dock
...
# 	MENU_DEFINITION
# 	MENU_CONVERSION
# 	MENU_EXPRESSION						 (calulator is in here!)
...
###############################################################################
echo "Address Book and some other apps"
...
# Show the app in the background if it’s not the front-most window
defaults write com.twitter.twitter-mac HideInBackground -bool false

# @todo: Still to add...
# Install ChitChat via Brew Cask
# Install Caprina via Brew Cask
# Install is-online-cli via npm -g
...
defaults write com.divisiblebyzero.Spectacle MoveToBottomHalf -data 
...
defaults write com.divisiblebyzero.Spectacle MoveToLeftHalf -data 
...
defaults write com.divisiblebyzero.Spectacle MoveToRightHalf -data 
defaults write com.divisiblebyzero.Spectacle MoveToTopHalf -data 
